...
//        dd( $data['allData']->toArray());
        return view('admin.backend.Account.employee_salary.employee_salary_view',$data);

    }
    public function AccountSalaryAdd(){

        return view('admin.backend.Account.employee_salary.employee_salary_add');
    }
    ...
    public function AccountSalaryStore(Request $request){
        ...
        if (!empty(@$data) || empty($checkdata)) {
            ...
            return redirect()->route('account.teacher.fee.view')->with($notification);
        }else{
