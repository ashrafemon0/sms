...
@section('admin')
                    ...
                    <div class="col-12">
                        <div class="box bb-3 border-warning">
                            <div class="box-header">
                                <h4 class="box-title">Student <strong>Book Fee</strong></h4>
                            </div>
    ...
    <script type="text/javascript">
        $(document).on('click', '#search', function(){
            ...
            var fee_category_id = $('#fee_category_id').val(); // Assuming you have a dropdown or input for fee_category_id

            $.ajax({
                url: "{{ route('student.book.fee.classwise.get') }}",
                type: "get",
                data: {
                    'year_id': year_id,
                    'class_id': class_id,
