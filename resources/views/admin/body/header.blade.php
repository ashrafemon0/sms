            ...
            <ul class="nav navbar-nav">
                    ...
                    <ul class="dropdown-menu animated bounceIn">
                        ...
                        <li>
                            <ul class="menu sm-scrol">
                                ...
                                <li>
                                    <a href="#"><i class="fa fa-user text-success"></i> Nullam euismod dolor ut quam interdum.</a>
                                </li>
                            </ul>
                        </li>
                        <li class="footer">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown" title="User">
                        <img src="{{ $user->image ? url('upload/user_image/'.$user->image) : url('upload/no_image.jpg') }}" alt="User Image">
                    </a>
                    @if($user->user_id) <!-- Check if user_id exists -->
