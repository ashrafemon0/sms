...
class ProfitController extends Controller
{
    public function MonthlyProfitView(){
        return view('admin.backend.report.profit.profit_view');
    ...
    public function MonthlyProfitDatewais(Request $request){
        ...
        $html['tdsource'] .='<td>';
        $html['tdsource'] .='<a class="btn btn-sm btn-'.$color.'" title="PDF" target="_blanks" href="'.route("admin.backend.report.profit.pdf").'?start_date='.$sdate.'&end_date='.$edate.'">Pay Slip</a>';
        $html['tdsource'] .= '</td>';
